...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        ...
        CT(KC_ESC),    CT(KC_A),AT(KC_S),ST(KC_D),GT(KC_F),KC_G,    KC_H,    GT(KC_J),ST(KC_K),AT(KC_L),   CT(KC_SCLN), KC_QUOT,            KC_ENT,           KC_MNXT,
        KC_LSFT,       KC_Z,    GT(KC_X),KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, GT(KC_DOT), KC_SLSH,     KC_RSFT,  KC_UP,
