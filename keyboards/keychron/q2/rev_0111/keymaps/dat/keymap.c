...
KC_TILD,  KC_EXLM,   KC_AT,      KC_HASH, KC_DLR,     KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_SCLN,     _______,    _______,  _______,  _______,  _______,
_______,  S(KC_EQL), KC_MINS,    KC_LCBR, KC_LPRN,    KC_LBRC,  KC_RBRC,  KC_RPRN,  KC_RCBR,  S(KC_SCLN),     S(KC_SCLN), _______,  _______,            _______,
...
_______,  _______,  _______,  _______,  _______,  _______,  S(KC_TAB),  G(KC_TAB), A(KC_TAB),  C(KC_TAB),  _______,  _______,            _______,
_______,  _______,  _______,                      _______,                      _______,  _______,  _______,            _______,  _______,  _______
        ),
...
_______,  KC_0,      KC_1,     KC_2,     KC_3,     KC_ASTR,  _______,  KC_RCMD,  KC_RSFT,  KC_LOPT,  KC_LCTL,  _______,  _______,            _______,
_______,  KC_MINS,   KC_4,     KC_5,     KC_6,     _______,  _______,  _______,  KC_RCMD,  _______,  _______,  _______,            _______,
_______,  _______,   _______,                      _______,                      _______,  _______,  _______,            _______,  _______,  _______
        ),
